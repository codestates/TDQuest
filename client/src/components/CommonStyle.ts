...
// Header Menu item, todopage, statuspage, raidjoinpage, raidpage, rankingpage, mainpage, signpage
...
// font 변경이 필요할 경우, 아래의 font 코드만 수정하여도 가능
// laptop screen
...
// tablet screen
export const fontSize_h1_tablet = "32px";
export const fontSize_h2_tablet = "26px";
export const fontSize_h3_tablet = "20px";
export const fontSize_body_tablet = "15px";
export const fontSize_smallButton_tablet = "15px";
export const fontSize_bigButton_tablet = "17px";
